...
import { OMNIDEF } from './docDocEnglish_def.js';
import tmpl from './docDocEnglish.html';
import tmpl_nds from './docDocEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docDocEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
