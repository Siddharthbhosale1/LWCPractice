...
import { OMNIDEF } from './lPIDocumentGenerationEnglish_def.js';
import tmpl from './lPIDocumentGenerationEnglish.html';
import tmpl_nds from './lPIDocumentGenerationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lPIDocumentGenerationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
